-- Migration 020 : Logement créé inactif si pas de mandat SEPA
-- is_active = FALSE tant que sepa_mandate_active n'est pas TRUE sur le profil
...
DECLARE
  ...
  v_role user_role;
  v_sepa_active BOOLEAN;
BEGIN
  SELECT role, sepa_mandate_active
    INTO v_role, v_sepa_active
  ...
  INSERT INTO properties (
    ...
    specificities, latitude, longitude,
    is_active
  ) VALUES (
